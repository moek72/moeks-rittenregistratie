// Moek's Rittenregistratie â€” app logica
...
// â”€â”€ Opslag â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Status & active trip UI â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ GPS / reverse geocoding â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

async function fetchGPS(pcId, plaatsId, btnId) {
  const btn = document.getElementById(btnId);
  const orig = btn.innerHTML;
  btn.innerHTML = 'â³ Ophalenâ€¦';
  btn.disabled = true;
...
// â”€â”€ Start rit â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Km-diff berekening â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ BeÃ«indig rit â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function initStopModal() {
  ...
  document.getElementById('btn-stop-confirm').addEventListener('click', async () => {
    ...
    updateStats();
    renderTrips();
    toast(`Rit beÃ«indigd! ${rit.km} km gereden.`);
  });
}

// â”€â”€ Ritten lijst â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function renderTrips() {
  ...
  summary.textContent = `${trips.length} ritten â€¢ ${total} km totaal`;
  ...
  list.innerHTML = trips
    ...
    .map((rit, revIdx) => {
      ...
      const vertrek   = [rit.startPostcode, rit.startPlaats].filter(Boolean).join(' ') || 'â€“';
      const aankomst  = [rit.endPostcode,   rit.endPlaats  ].filter(Boolean).join(' ') || 'â€“';
      const badgeCls  = rit.soort === 'zakelijk' ? 'badge-zakelijk' : 'badge-prive';

      return `
        <div class="trip-card">
          <div class="trip-card-header">
            <div class="trip-date">${dateStr} â€¢ ${timeStr}</div>
            <div class="trip-km">${rit.km} km</div>
          </div>
          <div class="trip-route">${escHtml(vertrek)} â†’ ${escHtml(aankomst)}</div>
          <div class="trip-card-footer">
            <span class="badge ${badgeCls}">${escHtml(rit.soort)}</span>
            <button class="btn-delete-trip" data-idx="${realIdx}" title="Verwijder rit">ðŸ—‘</button>
          </div>
        </div>`;
    })
    .join('');
...
// â”€â”€ Verwijder alles â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Google Sheets export â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Instellingen â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function initSettings() {
  ...
  document.getElementById('btn-save-settings').addEventListener('click', () => {
    ...
    saveSettings();
    toast('Instellingen opgeslagen âœ“');
  });
}
